...
> 전처리 완료
> - 1) size -> 전부 mb로 통일
> - 2) installs -> , + 제거하고 숫자로 변환
> - 3) 이상치 (index 10472) 삭제
> - 4) 결측치 -> 일부는 sklearn으로 median 처리. 일부는 삭제.
>
> 분석
> - 1) review 수 많은 순으로 나열 -> 인기 많은 어플.(review 수로 어플의 성공을 판단할 수 있지 않을까)
> - 2) 일단 수치적으로 높은 상관 관계를 보였던 건 review와 installs 였지만 더 자세한 분석을 해봐야 알 수 있을 것 같음.
